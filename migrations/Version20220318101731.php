 ...
 */
final class Version20220318101731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD blocked_expiration_at DATETIME DEFAULT NULL');
    }
